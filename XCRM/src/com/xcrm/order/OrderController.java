...
public class OrderController extends AbstractController {
  ...
  public void list() {
    ...
    String sqlExcept = " from `order` o  " + "left join orderitem oi on o.id=oi.order and o.status <> 4 " + "left join bookitem bi on oi.bookitem=bi.id "  + "left join product p on bi.product=p.id "
