...
public class AttributeID {
   ...
   * 
  '101', '颜色', '2', '红色,蓝色,绿色,白色,紫色,卡其色'
  '102', '型号', '2', 'XXL,XL,L,M,S'
  '103', '数量单位', '2', '件,个'
  '104', '时间单位', '2', '天,小时'
  '105', '数量', '1', NULL
  '106', '交货期', '1', NULL
   ...
   * 
  '201', '部门', '2', '礼服部,摄像部,化妆部,选片部,设计部,取件部,客服部'
  '202', '工作部门', '3', '礼服部,摄像部,化妆部,选片部,设计部,取件部,客服部'
  '203', '产品类型', '2', '婚纱,礼服'
  '204', '产品面料', '2', '白沙,蕾丝'
  '205', '产品颜色', '3', '红色,黄色,蓝色,白色,粉色,紫色'
  '206', '产品尺码', '2', 'S,M,L,XL,XXL'
   */
